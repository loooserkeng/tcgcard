...
export const Settings: React.FC<SettingsProps> = ({
  ...
  return (
    ...
    >
      {/* Ambient Red Glow */}
      <div className="absolute top-8 left-1/2 -translate-x-1/2 w-80 h-80 bg-red-600/15 blur-3xl pointer-events-none" />

      {/* Header */}
      <div className="mb-8 relative z-10">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-950/60 border border-red-500/30 text-[10px] font-mono font-bold tracking-widest text-red-300 mb-2">
          <SettingsIcon className="w-3 h-3 text-red-400" />
        ...
        <p className="text-xs sm:text-sm font-sans text-red-200/80 mt-1">
          Configure sound effects, procedural background music, database sync, and collection memory.
        </p>
      </div>

      <div className="space-y-6 relative z-10">
        {/* --- SUPABASE CLOUD SYNC CONFIGURATION --- */}
        <div className="rounded-2xl bg-[#140205]/90 border border-red-500/30 p-5 sm:p-6 space-y-4 shadow-xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-red-200/70 font-sans mt-1">
                PostgreSQL database storing card catalog, player accounts, opened booster pack histories, and card photo assets.
              </p>
            </div>
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-red-950/60 hover:bg-red-900/80 border border-red-500/40 text-red-200 font-mono font-bold text-xs flex items-center gap-2 cursor-pointer transition-all shrink-0"
            >
        ...
        {/* --- AUDIO SECTION --- */}
        <div className="rounded-2xl bg-[#140205]/90 border border-red-500/30 p-5 sm:p-6 space-y-5 shadow-xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-red-200/70 font-sans">
            ...
            <button
              ...
              className={`w-12 h-6 rounded-full transition-colors relative cursor-pointer ${
                settings.soundEnabled ? 'bg-red-600' : 'bg-black/60 border border-red-950'
              }`}
            >
              <div
          ...
          {settings.soundEnabled && (
            <div className="pl-12 flex items-center gap-4">
              ...
              />
              <span className="text-xs font-mono text-red-300 w-10 text-right">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-red-500/15">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-red-950/60 border border-red-500/30 flex items-center justify-center text-rose-400">
                <Music className="w-4 h-4" />
              </div>
              <div>
                <div className="text-sm font-bold text-white font-serif">Ambient Soundtrack</div>
                <div className="text-xs text-red-200/70 font-sans">
                  Procedural synth backdrop for pack openings and gallery browsing.
                </div>
              </div>
            </div>
            <button
              ...
              className={`w-12 h-6 rounded-full transition-colors relative cursor-pointer ${
                settings.musicEnabled ? 'bg-red-600' : 'bg-black/60 border border-red-950'
              }`}
            >
              <div
                className={`w-5 h-5 rounded-full bg-white transition-transform ${
        ...
        <div className="rounded-2xl bg-[#140205]/90 border border-red-500/30 p-5 sm:p-6 space-y-4 shadow-xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-red-950/60 border border-red-500/30 flex items-center justify-center text-neutral-300">
            ...
            <button
              ...
              className={`w-12 h-6 rounded-full transition-colors relative cursor-pointer ${
                settings.reducedMotion ? 'bg-red-600' : 'bg-black/60 border border-red-950'
              }`}
            >
              <div
                className={`w-5 h-5 rounded-full bg-white transition-transform ${
        ...
        {isAdmin && (
          <div className="rounded-2xl bg-gradient-to-r from-red-950/60 via-black to-red-950/60 border border-amber-500/40 p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-xl">
            <div>
              ...
              <div className="text-xs text-red-200/70 font-sans mt-0.5">
                Upload real photos and mint new actress cards into the master booster pack pool.
              </div>
            </div>
            <button
              onClick={onOpenAddCard}
              className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 text-white font-mono font-bold text-xs flex items-center gap-2 cursor-pointer shadow-md shadow-red-600/30 transition-all shrink-0 border border-red-400/40"
            >
        ...
        <div className="rounded-2xl bg-red-950/20 border border-red-500/25 p-5 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-red-600/20 hover:bg-red-600/30 border border-red-500/40 text-red-300 font-mono font-bold text-xs uppercase cursor-pointer transition-all shrink-0"
            >
              RESET LOCAL CACHE
            </button>
          </div>
      ...
      {showConfirmReset && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md p-4">
          <div className="relative w-full max-w-md rounded-3xl bg-[#140205] border border-red-500/40 p-6 shadow-2xl text-center">
            ...
            <p className="text-xs font-sans text-neutral-300 mt-2 leading-relaxed">
              This will erase all your unlocked Actress Cards, duplicates count, and opened pack histories in local cache.
            </p>
