...
export const ParticleCanvas: React.FC<ParticleCanvasProps> = ({
  ...
  useEffect(() => {
    ...
    // Initial ambient floating red embers and gold specks
    const ambientCount = 40;
    particlesRef.current = [];
    const redPalette = ['#ef4444', '#dc2626', '#b91c1c', '#ff2e5b', '#f87171', '#fbbf24'];
  ...
  useEffect(() => {
    ...
    // Fully red-and-gold themed particle bursts
    const colors =
      burstType === 'legendary'
        ? ['#fbbf24', '#f59e0b', '#ef4444', '#dc2626', '#ffffff', '#fef08a']
        : burstType === 'epic'
        ? ['#ef4444', '#dc2626', '#b91c1c', '#ff2e5b', '#ffffff']
        : ['#f87171', '#ef4444', '#dc2626', '#fbbf24', '#ffffff'];
